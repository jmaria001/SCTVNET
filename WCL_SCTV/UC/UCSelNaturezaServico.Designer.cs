namespace WCL_SCTV
{
    partial class UCSelNaturezaServico
    {
        /// <summary> 
        ...
        this.dataGridViewColumnPercentual_Iss};
            this.Name = "UCSelNaturezaServico";
            this.WindowText = "Seleciona Natureza de Serviços";
            this.Load += new System.EventHandler(this.UCSelNaturezaServico_Load);
