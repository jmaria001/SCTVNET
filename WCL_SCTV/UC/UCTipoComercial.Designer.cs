namespace WCL_SCTV
{
    partial class UCTipoComercial
    {
        ...
        this.dataGridViewColumnMerchandising};
            this.Name = "UCTipoComercial";
            this.WindowText = "Pesquisa Tipo de Comercial";
            this.Load += new System.EventHandler(this.UCTipoComercial_Load);
